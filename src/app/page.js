        ...
        <header className="fixed">
          <div className="fixed bottom-0 left-1/2 -translate-x-1/2 p-4">
            <svg
              ...
              className={`max-h-full w-auto transition-opacity duration-600 ${
                currentPage !== '' ? 'hover:opacity-80 hover:blur-xs' : ''
              }`}
          ...
          <nav className="fixed w-full top-0 left-0 p-4">
            <ul>
              <li
                className={`mb-4 h-full transition-all duration-600 ${
                  currentPage === 'about'
                    ? 'invert opacity-80'
              ...
              >
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`relative transform transition-all duration-600 ease-in-out ${
                    currentPage === ''
              ...
              >
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`relative transition-all duration-600 delay-100 ease-in-out ${
                    currentPage === ''
                      ? 'left-1/2 -translate-x-1/2'
                      : 'left-0 -translate-x-0'
                  }`}
              ...
              >
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`relative transition-all duration-600 delay-200 ease-in-out ${
                    currentPage === ''
                      ? 'left-1/2 -translate-x-1/2'
                      : 'left-0 -translate-x-0'
                  }`}
